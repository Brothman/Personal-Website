        ...
        return (
            <div className="about-container">
                ...
                <div className="skill-icons">
                    ...
                    <i onClick={this.visitAWS} class=" skill-icon devicon-amazonwebservices-plain-wordmark colored"></i>
                    ...
                    <i onClick={this.visitRuby} class="skill-icon devicon-ruby-plain-wordmark colored"></i>
                ...
                <div className="resume-icons">
                    <i onClick={this.visitResume} class="skill-icon far fa-file"></i>
                </div>

                <h1 className="help">I can help.</h1>
                <span className="freelance">I'm currently available for freelance work.</span>
                <span className="be-in-touch">Please reach out if I can be of service to you.</span>
